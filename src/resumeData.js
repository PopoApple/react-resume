      ...
      },
      {
        ...
        "projects": [
          { "title": "微服务云平台", "date": "2014.10 - 2016.10", "tag": "PC端Web应用", 
            ...
            "desc": "该项目是一个一站式建站服务平台，实现快速搭建手机微站的功能，包含所见即所得的微站设计、内容管理、站点托管、运营管理等功能。其中前端的核心功能是所见即所得的微站设计，以拖拽组件加配置的方式，从单个页面布局到多个页面间跳转，从静态内容编辑到动态数据源设置，轻松生成一个完整可用的手机微站。使用的技术主要是HTML5、JQuery、MUI。",
          ...
          { "title": "易应用", "date": "2013.06 - 2013.12", "tag": "PC端Web应用", 
            ...
            "desc": "该项目是一款PC端网页转移动端网页的工具，实现方式是自动抓取PC端网页内容和智能套用移动端的UI组件。使用的技术主要是JQueryMobile。",
            "duty": "负责移动端UI组件的开发。"
          },
